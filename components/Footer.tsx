    ...
    return (
        <footer className="relative pt-20" id="contact">
            <div className='w-full -mt-40'>
                <img src="/footer-grid.svg" alt="footer-grid" className='w-full opacity-50 h-[600px] max-sm:h-[630px] object-cover' />
            </div>
            <div className='w-full absolute inset-0'>
                <h1 className="mt-28 mx-auto heading max-w-[43rem]">
                ...
                <div className='flex justify-center'><NewButton title='Get in Touch' icon={<FaPaperPlane />} position='right'
                    handleClick={() => {
