...
export const BentoGridItem = ({
    ...
    const rightLists = ["MySQL", "TailWind", "Python"];
...
return (
    ...
    <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        <BackgroundGradientAnimation>
            <div className="pointer-events-none absolute z-40 inset-0 flex items-center justify-center text-white font-bold px-4 text-3xl text-center md:text-4xl lg:text-7xl"></div>
        </BackgroundGradientAnimation>
        )}
        ...
        {id === 6 && (
            ...
            <div className={`pointer-events-none absolute -bottom-5 right-0 ${copied ? "block" : "block" }`} >
