...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 w-screen max-w-7xl overflow-hidden  [mask-image:linear-gradient(to_right,transparent,white_10%,white_80%,transparent)]",
        className
      )}
    >
      <ul
        ...
        {items.map((item, idx) => (
          <li
            className="w-[90vw] max-w-full relative rounded-2xl border
             flex-shrink-0 border-white/[0.2] p-5 md:p-16 md:w-[768px] bg-black-100 hover:bg-gray-900 shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
            key={idx}>
            <blockquote>
